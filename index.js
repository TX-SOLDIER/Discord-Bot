...
const qotdQuestions = [
  ...
  // 🤔 Would You Rather (Merged with extra hard)
...
End Transmission.`);
  ...
  'Bro thinks he's the main character, but you're not even in the opening credits.',
'You've got more filler than a Naruto flashback.',
'You talk big, but your aura screams background NPC.',
'You're the type of villain who gets defeated in one episode just to hype the real boss.',
'You've got aim like a stormtrooper on low sensitivity.',
'You're basically the tutorial boss—easy, forgettable, and only there so others can learn the game.',
...
'You've got more missed messages than actual friends.',
'Your mic quality sounds like you're calling in from the Shadow Realm.',
'Even Google can't search up who asked.',
